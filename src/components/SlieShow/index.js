...
const SlideShow = (props) => {
  ...
  return (
    <>
      <div className="flex items-start w-full overflow-hidden relative group/btn" ref={wrapper}>
        <div className="flex flex-nowrap transition-transform ease-in-out duration-500" ref={slider}>
          {slides.map((item, index) => (
            <div style={{ width: `${wrapperWidth?.width}px` }} key={`slide-show-${index}`}>
              <img
